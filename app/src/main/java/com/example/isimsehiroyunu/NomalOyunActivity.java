...
public class NomalOyunActivity extends AppCompatActivity {


    private TextView txtIlBilgi, txtIlHarfSayisi, txtPuan, txtInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nomal_oyun);
